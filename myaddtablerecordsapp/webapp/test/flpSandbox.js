		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Add Employee Records",
									"targetURL": "#ui5appsmyaddtablerecordsapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5appsmyaddtablerecordsapp-display": {
								"semanticObject": "ui5appsmyaddtablerecordsapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.apps.myaddtablerecordsapp",
									"url": sap.ui.require.toUrl("ui5/apps/myaddtablerecordsapp")
								}
							}
						}
					}
